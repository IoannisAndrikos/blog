        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="text-xs font-bold uppercase {{ request()->is('register') ? 'text-blue-500' : '' }}">Register</a>
                    <a href="{{ route('login') }}" class="ml-6 text-xs font-bold uppercase {{ request()->is('login') ? 'text-blue-500' : '' }}">Log In</a>
                @endauth
